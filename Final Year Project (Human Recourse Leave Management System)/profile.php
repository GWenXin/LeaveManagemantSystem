	...
	if($row = mysqli_fetch_assoc($profile))
{
 ?>
    ...
    <table width="398" border="0" align="center" cellpadding="0">
	  ...
	  <tr>
      <td><input type="button" name="edit" value="Edit Profile" onclick="location.href='edit_profile.php'"/></td>
      <td><input type="button" name="changepassword" value="Change Password" onclick="location.href='change_password.php'" /></td>	
	</tr>
    </table>
	<br/>
